...
predicate = "partition_2 == '" + year + "' and partition_3 == '" + month + "' and partition_4 == '" + day + "'"
print(predicate)

glueContext = GlueContext(SparkContext.getOrCreate())

df1 = glueContext.create_data_frame.from_catalog(
    database=args["DATABASE"], table_name=args["TABLE"], transformation_ctx="cdrs", push_down_predicate=predicate
)
